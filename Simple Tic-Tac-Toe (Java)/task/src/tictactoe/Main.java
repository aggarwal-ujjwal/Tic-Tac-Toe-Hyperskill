...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //printGrid(input);
        while(result==-1) {
            input = userMakeMove(input, charCountMap);
            gameState(input);
        }
    ...
    private static String userMakeMove(String input, HashMap<Character, Integer> charCountMap) {
